...
export function KafkaBrokerNode({ data, selected }: NodeProps) {
  const d = data as unknown as KafkaBrokerData
  const s = CATEGORY_STYLES.messaging

  return (
    <>
      <NodeResizer isVisible={!!selected} minWidth={260} minHeight={80} lineClassName="!border-[#f87171]" handleClassName="!bg-[#f87171] !w-2 !h-2" />
      <div
