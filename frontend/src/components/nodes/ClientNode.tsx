...
export function ClientNode({ data, selected }: NodeProps) {
  ...
  return (
    <>
      <NodeResizer isVisible={!!selected} minWidth={140} minHeight={80} lineClassName="!border-[#a78bfa]" handleClassName="!bg-[#a78bfa] !w-2 !h-2" />
      <div
        className="rounded-lg w-full h-full p-3 text-center"
